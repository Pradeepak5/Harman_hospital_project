...
result= conn.execute("UPDATE DOCTORS SET NAME='"+getName+"',EMAIL_ID='"+getEmail+"',QUALIFICATION='"+getQuali+"',ADDRESS='"+getAdd+"' WHERE PHNO='"+getPhno+"'")
conn.commit()
print("Entry Updated successfully")
result = conn.execute("SELECT * FROM DOCTORS WHERE PHNO='"+getPhno+"'")
